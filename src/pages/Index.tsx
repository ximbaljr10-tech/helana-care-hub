...
const Index = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 8.5 Google Reviews - <GoogleReviews /> Depoimentos Reais */}
     
      
      {/* 8.6 Gallery -  <Gallery /> Ambiente do Consultório */}
     
      
      {/* 8.7 Instagram -  <InstagramSection /> Conteúdo Social */}
     
      
      {/* 8.8 Location -  <Location />Localização e Contato */}
