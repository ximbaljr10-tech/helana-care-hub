...
const HowItWorks = () => {
  ...
  return (
    <section className="section-padding-lg bg-gradient-to-b from-white to-background">
      <div className="container mx-auto px-4">
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-[hsl(40,25%,88%)] hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 relative z-10">
                ...
                {/* Content */}
                <h3 className="text-2xl font-serif font-bold text-brand-dark mb-4 text-center">
                  {step.title}
                </h3>
        ...
        >
          <p className="text-lg text-brand-muted italic flex items-center justify-center gap-2">
