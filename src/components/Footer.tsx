          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href={googleMapsLink} target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors">
                    Avaliações Google
                  </a>
                </li>
                <li>
                  <a href={instagramLink} target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors">
                    Instagram
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-white/80">Águas Claras, Brasília - DF</span>
                </li>
                <li className="flex items-start gap-2">
