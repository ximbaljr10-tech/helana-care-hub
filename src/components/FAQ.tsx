...
const FAQ = () => {
  ...
  return (
    <section className="section-padding-lg bg-gradient-to-b from-background to-white">
      <div className="container mx-auto px-4">
              ...
              >
                ...
                >
                  <AccordionTrigger className="text-left hover:text-primary transition-colors py-6">
                    <span className="text-base md:text-lg font-semibold pr-4 text-brand-dark">{faq.question}</span>
                  </AccordionTrigger>
                  <AccordionContent className="pb-6">
                    <p className="text-brand-muted leading-relaxed pl-4 border-l-2 border-primary/20">
                      {faq.answer}
                    </p>
                  </AccordionContent>
                </AccordionItem>
        ...
        >
          <p className="text-lg text-brand-dark font-semibold mb-4">
