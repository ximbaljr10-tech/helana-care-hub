...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-secondary/30 via-background to-background pt-16 md:pt-20 px-4 md:px-8">
      ...
      <div className="container mx-auto px-4 py-8 md:py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-5 py-2 sm:py-2.5 bg-white/95 backdrop-blur-sm rounded-xl shadow-soft border border-primary/20 hover:shadow-medium transition-all duration-300 hover:-translate-y-0.5">
            ...
            <div className="space-y-4">
              ...
              {/* LOCALIZAÇÃO SEMPRE VISÍVEL - COMPACTA E CENTRALIZADA */}
              <motion.div
                className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-2 px-4 py-2 sm:px-5 sm:py-2.5 bg-primary/10 rounded-xl border border-primary/30 max-w-fit mx-auto sm:mx-0"
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-primary">Águas Claras, Brasília - DF</span>
                </div>
                <button
            ...
            {/* Trust Indicators with Animated Counters - FORÇAR HORIZONTAL */}
            <motion.div 
              className="flex flex-row items-center justify-center sm:justify-start gap-4 sm:gap-6 md:gap-8 pt-4 sm:pt-6 md:pt-8 border-t border-border"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="flex-1 text-center">
                ...
                <p className="text-[10px] sm:text-xs md:text-sm text-muted-foreground font-semibold mt-1">Anos</p>
              </div>
            </motion.div>
          </motion.div>
